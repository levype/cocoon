...
ActiveRecord::Schema.define(version: 20151109103403) do
  ...
  add_index "adds", ["landlord_id"], name: "index_adds_on_landlord_id", using: :btree
  ...
  add_foreign_key "adds", "landlords"
